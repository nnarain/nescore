...
fn branch_timing_branch_basics() {
    ...
    common::run_test(&mut nes, 6, "Branch timing basic test failed with");
}
...
fn branch_timing_branch_backward() {
    ...
    common::run_test(&mut nes, 6, "Branch backward test failed with");
}
...
fn branch_timing_branch_forward() {
    ...
    common::run_test(&mut nes, 6, "Forward backward test failed with");
}
